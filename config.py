...
SMTP_USERNAME = os.getenv("SMTP_USERNAME", "vorataher53@gmail.com")
SMTP_PASSWORD = os.getenv("SMTP_PASSWORD", "")
SMTP_FROM_ADDRESS = os.getenv("SMTP_FROM_ADDRESS", "vorataher53@gmail.com")
NOTIFY_EMAIL_TO = [a.strip() for a in os.getenv("NOTIFY_EMAIL_TO", "vorataher53@gmail.com").split(",") if a.strip()]
